...
<head>
  ...
  <title><?php echo $name ?>: <?php echo htmlspecialchars((string) $message, ENT_QUOTES, sfConfig::get('sf_charset', 'UTF-8')) ?></title>
  <style type="text/css">
...
<body>
  ...
  <h2 id="message"><?php echo str_replace("\n", '<br />', htmlspecialchars((string) $message, ENT_QUOTES, sfConfig::get('sf_charset', 'UTF-8'))) ?></h2>
  <h2>stack trace</h2>
