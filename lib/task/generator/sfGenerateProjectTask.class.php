...
EOF;
  ...
  protected function execute($arguments = array(), $options = array())
  {
    ...
    if (!in_array(strtolower((string) $options['orm']), array('propel', 'doctrine', 'none')))
    {
    ...
    $symfonyCoreAutoload = str_starts_with((string) sfConfig::get('sf_symfony_lib_dir'), (string) sfConfig::get('sf_root_dir')) ?
  ...
  {
    if (preg_match('#^(https?|ftps?)://#', (string) $installer))
    {
