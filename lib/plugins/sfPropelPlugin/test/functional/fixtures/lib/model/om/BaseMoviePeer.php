...
abstract class BaseMoviePeer {
	...
	public const OM_CLASS = 'Movie';

	/** A class that can be returned by this peer. */
	public const CLASS_DEFAULT = 'lib.model.Movie';

	/** the related TableMap class for this table */
	public const TM_CLASS = 'MovieTableMap';
	...
	public const ID = 'movie.ID';

	/** the column name for the DIRECTOR field */
	public const DIRECTOR = 'movie.DIRECTOR';
	...
	public static function removeInstanceFromPool(mixed $value)
	{
		if (Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof Movie) {
				...
				$e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or Movie object; got " . (is_object($value) ? $value::class . ' object.' : var_export($value,true)));
				throw $e;
			}
	 ...
	 */
	public static function doValidate(Movie $obj, mixed $cols = null)
	{
		$columns = array();
