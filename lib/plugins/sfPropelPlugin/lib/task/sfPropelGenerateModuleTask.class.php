...
EOF;
  ...
  protected function execute($arguments = [], $options = [])
  {
    ...
    $this->constants = ['PROJECT_NAME'   => $properties['symfony']['name'] ?? 'symfony', 'APP_NAME'       => $arguments['application'], 'MODULE_NAME'    => $arguments['module'], 'UC_MODULE_NAME' => ucfirst((string) $arguments['module']), 'MODEL_CLASS'    => $arguments['model'], 'AUTHOR_NAME'    => $properties['symfony']['author'] ?? 'Your name here'];
  ...
  protected function executeGenerate($arguments = [], $options = [])
  {
    ...
    $this->getFilesystem()->replaceTokens($finder->in($moduleDir), '', '', ['auto'.ucfirst((string) $arguments['module']) => $arguments['module']]);
